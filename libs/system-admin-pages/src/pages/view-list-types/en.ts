...
export const shortenedFriendlyNameColumn = "Shortened Friendly Name";
export const urlColumn = "URL";
export const sensitivityColumn = "Default Sensitivity";
export const provenanceColumn = "Allowed Provenance";
export const nonStrategicColumn = "Non-Strategic";
export const subJurisdictionsColumn = "Sub-Jurisdictions";

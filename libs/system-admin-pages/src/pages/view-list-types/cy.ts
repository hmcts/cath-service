...
export const shortenedFriendlyNameColumn = "Enw Cyfeillgar Byrrach";
export const urlColumn = "URL";
export const sensitivityColumn = "Sensitifrwydd Rhagosodedig";
export const provenanceColumn = "Tarddiad a Ganiateir";
export const nonStrategicColumn = "Anstrategol";
export const subJurisdictionsColumn = "Is-awdurdodaethau";
export const actionsColumn = "Gweithredoedd";

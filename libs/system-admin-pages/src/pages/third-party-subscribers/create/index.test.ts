...
describe("third-party-subscribers create page", () => {
  ...
  describe("getHandler", () => {
    ...
    it("should pre-populate name from session", async () => {
      ...
      // Assert
      expect(res.render).toHaveBeenCalledWith("third-party-subscribers/create/index", expect.objectContaining({ data: { name: "Existing Name" } }));
    });
  ...
  describe("postHandler", () => {
    it("should redirect to summary on valid name", async () => {
      ...
      // Assert
      expect(res.redirect).toHaveBeenCalledWith("/third-party-subscribers/create/summary");
    ...
    it("should redirect to Welsh summary on valid name with Welsh param", async () => {
      ...
      // Assert
      expect(res.redirect).toHaveBeenCalledWith("/third-party-subscribers/create/summary?lng=cy");
    });
  });
});

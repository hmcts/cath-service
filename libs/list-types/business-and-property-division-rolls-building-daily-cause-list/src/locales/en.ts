...
export const en = {
  ...
  listingOfficeText: "The listing office will direct your enquiry to the appropriate person.",
  ...
  searchCasesLabel: "Search by case number, name, venue, judge, or other information",
  tableHeaders: {
    judge: "Judge",
    time: "Time",
    venue: "Venue",

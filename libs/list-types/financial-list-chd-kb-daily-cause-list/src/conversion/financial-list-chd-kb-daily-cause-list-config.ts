...
export const FINANCIAL_LIST_CHD_KB_EXCEL_CONFIG = CHD_KB_EXCEL_CONFIG;

const financialListChdKbConverter = createConverter(FINANCIAL_LIST_CHD_KB_EXCEL_CONFIG);
registerConverterByName("FINANCIAL_LIST_CHD_KB_DAILY_CAUSE_LIST", financialListChdKbConverter);

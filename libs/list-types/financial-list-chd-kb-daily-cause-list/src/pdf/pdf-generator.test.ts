...
import { renderFinancialListChdKbDailyCauseList } from "../rendering/renderer.js";
import { generateFinancialListChdKbDailyCauseListPdf } from "./pdf-generator.js";
...
describe("generateFinancialListChdKbDailyCauseListPdf", () => {
  beforeEach(() => {
    vi.clearAllMocks();

    vi.mocked(renderFinancialListChdKbDailyCauseList).mockReturnValue(mockRenderedData);
  ...
  it("should generate PDF successfully", async () => {
    ...
    const result = await generateFinancialListChdKbDailyCauseListPdf({
  ...
  it("should pass correct render options to renderer", async () => {
    ...
    await generateFinancialListChdKbDailyCauseListPdf({
    ...
    expect(renderFinancialListChdKbDailyCauseList).toHaveBeenCalledWith(mockHearingList, {
      locale: "en",

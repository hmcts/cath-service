...
export async function generateFinancialListChdKbDailyCauseListPdf(options: PdfGenerationOptions): Promise<PdfGenerationResult> {
  try {
    const renderedData = renderFinancialListChdKbDailyCauseList(options.jsonData, {

...
export const cy = {
  pageTitle: "Rhestr Achosion Dyddiol Ceisiadau Interim",
  ...
  venueName: "Adeilad Rolls",
  addressLine1: "Fetter Lane, London",
  addressLine2: "EC4A 1NL",
  importantInformationHeading: "Gwybodaeth bwysig",
  openJusticeMessage1: "Dylai partïon gysylltu â chlerc y Barnwr Interim ",
  openJusticeSeparator: ", ",
  openJusticeMessage2: " cyn gynted â phosibl.",
  openJusticeFallback: "Dylai partïon gysylltu â chlerc y Barnwr Interim cyn gynted â phosibl.",
  openJusticeMessage3:
    "Ni ddylid rhestru cais gerbron y Barnwr Ceisiadau Interim oni bai bod yr amser cyffredinol sydd ei angen i ddelio â'r cais yn 2 awr neu lai. Mae'r uchafswm o 2 awr yn cynnwys amser darllen ymlaen llaw y barnwr, gwrando’r cais, cyflwyno'r dyfarniad ac amser ar gyfer delio â chostau. Os yw'r barnwr o'r farn y bydd yr amcangyfrif yn fwy na'r terfyn 2 awr, gellir ei dynnu o'r rhestr ceisiadau interim.",
  openJusticeIndividualList: "Noder, ni fydd gwrandawiadau yn y rhestr ceisiadau interim yn ymddangos yn ychwanegol yn eu rhestr unigol.",

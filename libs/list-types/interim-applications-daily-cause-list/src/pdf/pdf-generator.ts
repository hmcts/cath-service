...
interface PdfGenerationOptions extends BasePdfGenerationOptions<InterimApplicationsData> {
  contentDate: Date;
}

export async function generateInterimApplicationsDailyCauseListPdf(options: PdfGenerationOptions): Promise<PdfGenerationResult> {
  try {
    const renderedData = renderInterimApplicationsDailyCauseList(options.jsonData, {

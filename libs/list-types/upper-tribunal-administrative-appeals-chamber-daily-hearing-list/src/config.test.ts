...
describe("upper-tribunal-administrative-appeals-chamber-daily-hearing-list config", () => {
  describe("moduleRoot", () => {
  ...
  describe("schemaPath", () => {
    ...
    it("should point to the schema file", () => {
      expect(schemaPath).toContain("upper-tribunal-administrative-appeals-chamber-daily-hearing-list.json");
    });

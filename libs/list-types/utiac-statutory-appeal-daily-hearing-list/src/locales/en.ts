...
export const en = {
  pageTitle: "Upper Tribunal (Immigration and Asylum) Chamber Statutory Appeal Daily Hearing List",
  ...
  searchCasesLabel: "Search by appeal reference number, appellant, judge, or other details",
  tableHeaders: {

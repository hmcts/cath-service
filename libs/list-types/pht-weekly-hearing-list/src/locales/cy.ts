...
export const cy = {
  pageTitle: "Rhestr Gwrandawiadau Wythnosol y Tribiwnlys Iechyd Sylfaenol",
  ...
  importantInformationText:
    "Cysylltwch â'r Rhestrau Iechyd Sylfaenol yn primaryhealthlists@justice.gov.uk i gael manylion am sut i gael mynediad at wrandawiadau fideo.",

...
export const PHT_EXCEL_CONFIG: ExcelConverterConfig = {
  fields: [
    {
      header: "Date",
      fieldName: "date",
...
const phtConverter = createConverter(PHT_EXCEL_CONFIG);
registerConverterByName("PHT_WEEKLY_HEARING_LIST", phtConverter);

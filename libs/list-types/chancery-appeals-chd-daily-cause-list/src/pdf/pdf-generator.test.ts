...
import { renderChanceryAppealsChdDailyCauseList } from "../rendering/renderer.js";
import { generateChanceryAppealsChdDailyCauseListPdf } from "./pdf-generator.js";
...
describe("generateChanceryAppealsChdDailyCauseListPdf", () => {
  beforeEach(() => {
    vi.clearAllMocks();

    vi.mocked(renderChanceryAppealsChdDailyCauseList).mockReturnValue(mockRenderedData);
  ...
  it("should generate PDF successfully", async () => {
    ...
    const result = await generateChanceryAppealsChdDailyCauseListPdf({
  ...
  it("should pass correct render options to renderer", async () => {
    ...
    await generateChanceryAppealsChdDailyCauseListPdf({
    ...
    expect(renderChanceryAppealsChdDailyCauseList).toHaveBeenCalledWith(mockHearingList, {
      locale: "en",

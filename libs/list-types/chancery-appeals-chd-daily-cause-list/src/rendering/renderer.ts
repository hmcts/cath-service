...
// Rendering logic is shared with other CHD/KB list types via @hmcts/chd-kb-common. The list title is
// specific to this list type, so it is sourced from this package's own locale files and passed in.
export function renderChanceryAppealsChdDailyCauseList(hearingList: ChdKbHearingList, options: RenderOptions): RenderedData {

...
describe("generateFamilyDailyCauseListPdf", () => {
  ...
  beforeEach(() => {
    ...
    mockLoadTranslations.mockResolvedValue({ title: "Family Daily Cause List" });

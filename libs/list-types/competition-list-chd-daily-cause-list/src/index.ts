import "./conversion/competition-list-chd-daily-cause-list-config.js"; // Register converter on module load
...
export {
  ...
  validateChdKbListType as validateCompetitionListChdDailyCauseList

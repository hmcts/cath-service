...
export const cy = {
  pageTitle: "Rhestr Achosion Dyddiol Cystadleuaeth (Adran Siawnsri)",
  ...
  importantInformationHeading2: "Gwrandawiadau o bell gerbron Meistr y Siawnsri",
  importantInformationLine2:
    "Os yw cynrychiolydd o'r cyfryngau neu aelod o'r cyhoedd yn dymuno mynychu'r gwrandawiad o bell, dylent gysylltu â chancery.mastersappointments@justice.gov.uk a fydd yn eu rhoi mewn cysylltiad â'r unigolyn perthnasol.",

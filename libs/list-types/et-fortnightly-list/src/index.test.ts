...
describe("index exports", () => {
  ...
  it("should export the English and Welsh locale content including rep keys", () => {
    expect(exports.etFortnightlyListEn.title).toBe("Employment Tribunals Fortnightly Press List");
    expect(exports.etFortnightlyListEn.rep).toBe("Rep");
    expect(exports.etFortnightlyListCy.title).toBe("Rhestr y Wasg Pob Pythefnos y Tribiwnlysoedd Cyflogaeth");

...
import { generateUtiacJrCardiffDailyHearingListPdf } from "./pdf-generator.js";
...
describe("generateUtiacJrCardiffDailyHearingListPdf", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it("should pass correct render options to renderer", async () => {
    ...
    // Act
    await generateUtiacJrCardiffDailyHearingListPdf({
    ...
    // Assert
    expect(renderUtiacJrCardiffDailyHearingListData).toHaveBeenCalledWith(mockHearingList, {
      locale: "cy",

...
describe("validateMagistratesPublicList", () => {
  it("should validate a correct magistrates public list", () => {
    const validData = {
      document: {
        publicationDate: "2025-11-12T09:00:00.000Z",
        documentName: "Magistrates Public List",
        version: "1.0"
      },
      venue: {
    ...
    const result = validateMagistratesPublicList(validData);
  ...
  it("should return errors for missing required fields", () => {
    ...
    const result = validateMagistratesPublicList(invalidData);

export const en = {
  title: "Magistrates' Public Adult Court List",
  pageTitle: "Magistrates' Public Adult Court List for",
  listFor: "List for",
  ...
  // TODO: confirm final reporting restriction wording with the business before launch.
  reportingRestrictions: "Reporting Restriction",
  reportingRestrictionWarning: "This case is subject to a reporting restriction. Please observe any applicable restrictions when reporting on this case.",

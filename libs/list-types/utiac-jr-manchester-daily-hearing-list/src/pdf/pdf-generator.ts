...
export async function generateUtiacJrManchesterDailyHearingListPdf(options: PdfGenerationOptions): Promise<PdfGenerationResult> {
  try {
    const renderedData = renderUtiacJrManchesterDailyHearingListData(options.jsonData, {

...
export const UTIAC_JR_MANCHESTER_EXCEL_CONFIG: ExcelConverterConfig = {
  fields: [
    {
      header: "Hearing time",
...
const utiacJrManchesterConverter = createConverter(UTIAC_JR_MANCHESTER_EXCEL_CONFIG);
registerConverter(33, utiacJrManchesterConverter);
registerConverterByName("UTIAC_JR_MANCHESTER_DAILY_HEARING_LIST", utiacJrManchesterConverter);

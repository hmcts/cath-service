...
export const INSOLVENCY_AND_COMPANIES_COURT_CHD_EXCEL_CONFIG = CHD_KB_EXCEL_CONFIG;

const insolvencyAndCompaniesCourtChdConverter = createConverter(INSOLVENCY_AND_COMPANIES_COURT_CHD_EXCEL_CONFIG);
registerConverterByName("INSOLVENCY_AND_COMPANIES_COURT_CHD_DAILY_CAUSE_LIST", insolvencyAndCompaniesCourtChdConverter);

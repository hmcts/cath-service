...
export const cy = {
  pageTitle: "Rhestr Achosion Dyddiol Llys Cwmnïau ac achosion Ansolfedd (Adran Siawnsri)",
  ...
  importantInformationLine1:
    "Os yw cynrychiolydd o'r cyfryngau neu aelod o'r cyhoedd yn dymuno mynychu'r gwrandawiad, dylent gysylltu â'r swyddfa restru yn chanceryjudgeslisting@justice.gov.uk a fydd yn eu rhoi mewn cysylltiad â'r unigolyn perthnasol.",
  importantInformationHeading2: "Gwrandawiadau o bell gerbron Barnwr y Llys Cwmnïau ac achosion Ansolfedd",
  importantInformationLine2:
    "Os yw cynrychiolydd o'r cyfryngau neu aelod o'r cyhoedd yn dymuno mynychu'r gwrandawiad, dylent gysylltu â'r Clerc y Barnwr yn rolls.icl.hearings1@justice.gov.uk a fydd yn eu rhoi mewn cysylltiad â'r unigolyn perthnasol.",
  importantInformationHeading3: "Dyfarniadau o bell",
  importantInformationLine3:

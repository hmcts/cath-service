...
describe("validateMagistratesAdultCourtList", () => {
  ...
  describe("HTML injection protection", () => {
    ...
    it("should reject HTML tags in court", () => {
      // Arrange
      const data = JSON.parse(JSON.stringify(VALID_DATA));
      data.document.data.job.sessions.session[0].court = "<b>North Shields</b>";
  ...
  describe("invalid input types", () => {
    ...
    it("should reject null", () => {
      // Act
      const result = validateMagistratesAdultCourtList(null);
    ...
    it("should reject a string", () => {
      // Act
      const result = validateMagistratesAdultCourtList("invalid");

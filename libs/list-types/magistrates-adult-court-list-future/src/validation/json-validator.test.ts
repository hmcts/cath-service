...
import { validateMagistratesAdultCourtListFuture } from "./json-validator.js";

describe("validateMagistratesAdultCourtListFuture", () => {
  it("should validate a correct magistrates adult court list", () => {
    ...
    const result = validateMagistratesAdultCourtListFuture(validData);
  ...
  it("should return errors for missing required fields", () => {
    const result = validateMagistratesAdultCourtListFuture({ document: { publicationDate: "2025-11-12T09:00:00.000Z" } });
  ...
  it("should return errors for invalid publication date format", () => {
    const result = validateMagistratesAdultCourtListFuture({

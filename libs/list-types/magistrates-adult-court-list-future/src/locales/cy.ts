export const cy = {
  title: "Rhestr Achosion y Llys Ynadon – Oedolion",
  pageTitle: "Rhestr Achosion y Llys Ynadon – Oedolion ar gyfer",
  ...
  // TODO: confirm final Welsh reporting restriction wording with the business before launch.
  reportingRestrictions: "Cyfyngiad Adrodd",
  reportingRestrictionWarning:
    "Mae'r achos hwn yn destun cyfyngiad adrodd. Sicrhewch eich bod yn cydymffurfio ag unrhyw gyfyngiadau perthnasol wrth adrodd ar yr achos hwn.",
  noHearings: "Dim gwrandawiadau wedi'u trefnu",

...
export const UTIAC_JR_BIRMINGHAM_EXCEL_CONFIG: ExcelConverterConfig = {
  fields: [
    {
      header: "Hearing time",
...
const utiacJrBirminghamConverter = createConverter(UTIAC_JR_BIRMINGHAM_EXCEL_CONFIG);
registerConverter(34, utiacJrBirminghamConverter);
registerConverterByName("UTIAC_JR_BIRMINGHAM_DAILY_HEARING_LIST", utiacJrBirminghamConverter);

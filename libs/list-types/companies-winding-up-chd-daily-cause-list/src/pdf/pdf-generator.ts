...
export async function generateCompaniesWindingUpChdDailyCauseListPdf(options: PdfGenerationOptions): Promise<PdfGenerationResult> {
  try {
    const renderedData = renderCompaniesWindingUpChdDailyCauseList(options.jsonData, {

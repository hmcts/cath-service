export const en = {
  ...
  version: "Version",
  headingP1: "Any representation about the listing of a case should be made to the Listing Officer immediately",
  headingP2: "The prosecuting authority is the Crown Prosecution Service unless otherwise stated",
  headingP3: "*denotes a defendant in custody",
  fixedFor: "Fixed For",

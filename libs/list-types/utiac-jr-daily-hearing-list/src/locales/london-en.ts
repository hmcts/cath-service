...
export const londonEn = {
  pageTitle: "Upper Tribunal (Immigration and Asylum) Chamber - Judicial Review: London Daily Hearing List",
  ...
  searchCasesLabel: "Search by case reference number, case title, judge, or other details",
  tableHeaders: {

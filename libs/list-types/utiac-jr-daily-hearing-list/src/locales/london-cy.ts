...
export const londonCy = {
  pageTitle: "[WELSH TRANSLATION REQUIRED: 'Upper Tribunal (Immigration and Asylum) Chamber - Judicial Review: London Daily Hearing List']",
  ...
  searchCasesLabel: "[WELSH TRANSLATION REQUIRED: 'Search by case reference number, case title, judge, or other details']",
  tableHeaders: {

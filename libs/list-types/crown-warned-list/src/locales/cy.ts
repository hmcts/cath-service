export const cy = {
  ...
  preStatementSuffix:
    ". Dylid gwneud unrhyw gynrychiolaeth am restru achos i'r Swyddog Rhestru ar unwaith. Yr awdurdod erlyn yw Gwasanaeth Erlyn y Goron oni nodir fel arall. *dynoda ddiffynnydd yn y ddalfa",

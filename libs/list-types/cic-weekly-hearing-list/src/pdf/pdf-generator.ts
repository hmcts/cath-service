...
interface PdfGenerationOptions extends BasePdfGenerationOptions<CicWeeklyHearingList> {
  contentDate: Date;
}

export async function generateCicWeeklyHearingListPdf(options: PdfGenerationOptions): Promise<PdfGenerationResult> {
  try {

...
import { generateCivilDailyCauseListPdf } from "./pdf-generator.js";
...
describe("generateCivilDailyCauseListPdf", () => {
  it("should delegate to generateDailyCauseListPdf with resolved provenance label", async () => {
    ...
    const result = await generateCivilDailyCauseListPdf(options);
  ...
  it("should use empty provenance label when provenance is not provided", async () => {
    ...
    await generateCivilDailyCauseListPdf({
  ...
  it("should return error result when generateDailyCauseListPdf fails", async () => {
    ...
    const result = await generateCivilDailyCauseListPdf({

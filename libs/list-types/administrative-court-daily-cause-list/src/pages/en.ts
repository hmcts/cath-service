export const en = {
  BIRMINGHAM_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST: {
    pageTitle: "Birmingham Administrative Court Daily Cause List",
    importantInfoText:
  ...
  LEEDS_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST: {
    pageTitle: "Leeds Administrative Court Daily Cause List",
    importantInfoText:
  ...
  MANCHESTER_ADMINISTRATIVE_COURT_DAILY_CAUSE_LIST: {
    pageTitle: "Manchester Administrative Court Daily Cause List",
    importantInfoText:

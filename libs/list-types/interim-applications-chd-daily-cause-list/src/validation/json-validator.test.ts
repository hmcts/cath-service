...
import { validateInterimApplicationsChdDailyCauseList } from "./json-validator.js";
...
describe("validateInterimApplicationsChdDailyCauseList", () => {
  it("should return valid when all required fields are present", () => {
    const data = JSON.parse(JSON.stringify(VALID_DATA));

    const result = validateInterimApplicationsChdDailyCauseList(data);

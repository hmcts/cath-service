...
function buildEditableParagraph(data: InterimApplicationsChdData, t: typeof en | typeof cy): string {
...
export function renderInterimApplicationsChdDailyCauseList(data: InterimApplicationsChdData, options: RenderOptions): RenderedData {

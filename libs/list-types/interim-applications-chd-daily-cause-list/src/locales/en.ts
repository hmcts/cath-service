...
export const en = {
  pageTitle: "Interim Applications List (Chancery Division) Daily Cause List",
  ...
  openJusticeFallback: "Parties should contact the clerk to the Interim Judge as early as possible.",
  openJusticeMessage3:

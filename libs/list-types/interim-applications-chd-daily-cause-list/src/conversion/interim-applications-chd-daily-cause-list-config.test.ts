...
import { INTERIM_APPLICATIONS_CHD_HEARINGS_CONFIG, OPEN_JUSTICE_CONFIG } from "./interim-applications-chd-daily-cause-list-config.js";
...
describe("interim applications ChD converter registration", () => {
  it("should be registered under the correct list type name", () => {
    expect(hasConverterForListTypeName("INTERIM_APPLICATIONS_CHD_DAILY_CAUSE_LIST")).toBe(true);
  });
});

...
export const INTERIM_APPLICATIONS_CHD_HEARINGS_CONFIG: ExcelConverterConfig = {
  fields: [
...
export const OPEN_JUSTICE_CONFIG: ExcelConverterConfig = {
  fields: [
    ...
    },
    {
      ...
      fieldName: "email",
      required: true,
      validators: [(value: string, rowNumber: number) => validateNoHtmlTags(value, "Email", rowNumber)]
    }
  ],
  minRows: 0
};
...
registerConverterByName("INTERIM_APPLICATIONS_CHD_DAILY_CAUSE_LIST", converter);

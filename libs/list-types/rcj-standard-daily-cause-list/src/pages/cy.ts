export const cy = {
  10: {
    ...
    courtExclusionText: "Gall y llys eithrio arsylwyr lle bo angen er mwyn sicrhau gweinyddu cyfiawnder yn briodol."
  },
  11: {
  ...
  13: {
    ...
    tipstaffText:
      "Dim ond os ydynt yn frys y gellir gwneud ceisiadau sydd heb eu rhestru i'r Llys Ceisiadau, a bod y brys yn codi o ryw ddatblygiad neu amgylchiad diweddar iawn. Ni ddylid gwneud cais i'r Llys Ceisiadau yn syml oherwydd nad yw ar rybudd i'r parti neu'r partïon eraill, oni bai ei fod yn frys fel y'i diffinnir uchod. Rhaid cyflwyno pob cais arall yn gyntaf, boed ar rybudd ai peidio, gydag amcangyfrif amser priodol, a'i restru ar ddyddiad a roddir gan Glerc y Rheolau.\n\nAc eithrio mewn amgylchiadau o frys eithafol, rhaid gwneud ceisiadau am 10.30am ac nid ar unrhyw amser hwyrach.\n\nNi ellir gwneud unrhyw gais i Lys Ceisiadau'r Uchel Lys y gellir ei wneud i haen is o farnwr. Os yw eich cais yn gofyn am wasanaethau'r Tipstaff rhaid i chi ffonio'r Tipstaff ar 020 7947 6200 cyn mynd i mewn i'r llys neu wneud eich cais. Ni fydd eich mater yn cael ei glywed nes i chi siarad â'r Tipstaff.",
    judgmentsTitle: "Dyfarniadau",
    judgmentsText:
      "Bydd dyfarniadau'n cael eu cyhoeddi o bell drwy eu cylchredeg i'r partïon neu eu cynrychiolwyr drwy e-bost a'u rhyddhau i'r Archifau Cenedlaethol. Dylai copi o'r dyfarniad yn ei ffurf derfynol fel y'i cyhoeddwyd fod ar gael ar wefan yr Archifau Cenedlaethol yn fuan wedi hynny."
  },
  14: {
    ...
    remoteJudgmentsText:
      "Cyhoeddi o bell: Bydd y dyfarniad hwn yn cael ei gyhoeddi o bell drwy ei gylchredeg i'r partïon neu eu cynrychiolwyr drwy e-bost a'i ryddhau i'r Archifau Cenedlaethol.\n\nDylai copi o'r dyfarniad yn ei ffurf derfynol fel y'i cyhoeddwyd fod ar gael ar wefan yr Archifau Cenedlaethol yn fuan wedi hynny. Gall aelodau o'r cyfryngau gael copi ar gais drwy e-bost i'r Swyddfa Farnwrol press.enquiries@judiciary.uk.",
    bundlesTitle: "Bwndeli",
    bundleFilingText:
      "Gwrandawiadau wyneb yn wyneb – Rhaid darparu unrhyw fwndeli i'w ffeilio mewn copi caled o leiaf 3 diwrnod cyn y gwrandawiad. Gellir dod â rhain i ystafell WG07 i'w danfon."
  },
  15: {
    ...
    judgmentsTitle: "Dyfarniadau",
    judgmentsText:
      "Bydd dyfarniadau a gyhoeddir gan y Meistr o bell yn cael eu rhyddhau drwy eu cylchredeg i gynrychiolwyr y partïon drwy e-bost a'u rhyddhau i'r Archifau Cenedlaethol. Bydd y dyddiad a'r amser ar gyfer cyhoeddi yn cael ei ystyried yn ddim cyn yr amser a restrir. Gellir darparu copi o'r dyfarniad yn ei ffurf derfynol fel y'i cyhoeddwyd ar ôl yr amser hwnnw, ar gais drwy e-bost.",
    bundlesTitle: "Bwndeli",
    bundlesText:
      "Gwrandawiadau wyneb yn wyneb – rhaid darparu bwndeli mewn copi caled o leiaf 3 diwrnod cyn y gwrandawiad. Gellir dod â'r rhain i'r Bear Garden i'w danfon.\n\nGwrandawiadau o bell – dylid darparu'r rhain yn electronig i'r Meistr a/neu eu clerc o leiaf 3 diwrnod cyn y gwrandawiad. Cyfeiriwch at gyfarwyddiadau o bell y meistri o fewn yr hysbysiad gwrandawiad am gyfarwyddiadau penodol.",
    inPersonHearingsTitle: "Gwrandawiadau Wyneb yn Wyneb",
    inPersonHearingsText:
      "Ni fydd gan bob gwrandawiad a nodir fel bod mewn ystafell neu ystafell llys gyswllt fideo oni nodir fel arall. Mae siambrau'r meistri yn gyfyngedig o ran lle i fynychwyr. Os disgwylir mwy na 6 o fynychwyr, cysylltwch â chlerc y meistri cyn gynted â phosibl i gynghori a ellir dod o hyd i ddewis arall addas.",
    kbGuideTitle: "Canllaw Mainc y Brenin",
    kbGuideLinkText: "Ffenestri treial cyfredol",

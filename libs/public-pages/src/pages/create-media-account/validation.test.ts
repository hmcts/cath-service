...
describe("validateEmail", () => {
  it("should return error when email is undefined", () => {
    const result = validateEmail(undefined, "Enter an email address", "Enter a valid email address");
    expect(result).toEqual({
      field: "email",
  ...
  it("should return error when email is empty", () => {
    const result = validateEmail("", "Enter an email address", "Enter a valid email address");
    expect(result).toEqual({
      field: "email",
      message: "Enter an email address",
      href: "#email"
  ...
  it("should return error when email format is invalid", () => {
    const result = validateEmail("notanemail", "Enter an email address", "Enter a valid email address");
    expect(result).toEqual({
      field: "email",
  ...
  it("should return error when email has no TLD", () => {
    const result = validateEmail("test@example", "Enter an email address", "Enter a valid email address");
    expect(result).toEqual({
      field: "email",
      message: "Enter a valid email address",
      href: "#email"
  ...
  it("should return error when email exceeds maximum length", () => {
    ...
    const result = validateEmail(longEmail, "Enter an email address", "Enter a valid email address");
    expect(result).toEqual({
      field: "email",
      message: "Enter a valid email address",
      href: "#email"
  ...
  it("should return null for valid email", () => {
    const result = validateEmail("test@example.com", "Enter an email address", "Enter a valid email address");
    expect(result).toBeNull();
  });

  it("should return null for valid email with plus sign", () => {
    const result = validateEmail("test+tag@example.com", "Enter an email address", "Enter a valid email address");
    expect(result).toBeNull();
  });

  it("should return null for valid email with dots", () => {
    const result = validateEmail("first.last@example.co.uk", "Enter an email address", "Enter a valid email address");
    expect(result).toBeNull();
  });

  it("should handle email with special characters in local part", () => {
    const result = validateEmail("test.name+tag@example.com", "Enter an email address", "Enter a valid email address");
    expect(result).toBeNull();
  });
  ...
  it("should protect against ReDoS with long invalid input", () => {
    ...
    const result = validateEmail(maliciousInput, "Enter an email address", "Enter a valid email address");

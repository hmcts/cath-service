...
describe("formatPublicationDate", () => {
  ...
  describe("Edge cases", () => {
    it("should default to English for unknown locale", () => {
      const result = formatPublicationDate("2025-04-12", "fr");
      expect(result).toBe("12 April 2025");
    });

    it("should handle ISO date string with time", () => {
      const result = formatPublicationDate("2025-04-12T10:30:00Z", "en");
      expect(result).toBe("12 April 2025");
    });
  });
});

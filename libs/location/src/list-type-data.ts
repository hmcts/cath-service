...
export const listTypeData: ListTypeData[] = [
  ...
  },
  {
    ...
    welshFriendlyName: "First-tier Tribunal (Residential and Property Tribunal) Eastern Region Weekly Hearing List",
    provenance: "MANUAL_UPLOAD",
    urlPath: "ftt-rpt-eastern-weekly-hearing-list",
    isNonStrategic: true,
    defaultSensitivity: "Public",
    shortenedFriendlyName: "RPT Eastern Weekly Hearing List",
    subJurisdictionIds: [24]
  },
  {
    id: 34,
    name: "FTT_RPT_LONDON_WEEKLY_HEARING_LIST",
    englishFriendlyName: "First-tier Tribunal (Residential and Property Tribunal) London Region Weekly Hearing List",
    welshFriendlyName: "First-tier Tribunal (Residential and Property Tribunal) London Region Weekly Hearing List",
    provenance: "MANUAL_UPLOAD",
    urlPath: "ftt-rpt-london-weekly-hearing-list",
    isNonStrategic: true,
    defaultSensitivity: "Public",
    shortenedFriendlyName: "RPT London Weekly Hearing List",
    subJurisdictionIds: [24]
  },
  {
    id: 35,
    name: "FTT_RPT_MIDLANDS_WEEKLY_HEARING_LIST",
    englishFriendlyName: "First-tier Tribunal (Residential and Property Tribunal) Midlands Region Weekly Hearing List",
    welshFriendlyName: "First-tier Tribunal (Residential and Property Tribunal) Midlands Region Weekly Hearing List",
    provenance: "MANUAL_UPLOAD",
    urlPath: "ftt-rpt-midlands-weekly-hearing-list",
    isNonStrategic: true,
    defaultSensitivity: "Public",
    shortenedFriendlyName: "RPT Midlands Weekly Hearing List",
    subJurisdictionIds: [24]
  },
  {
    id: 36,
    name: "FTT_RPT_NORTHERN_WEEKLY_HEARING_LIST",
    englishFriendlyName: "First-tier Tribunal (Residential and Property Tribunal) Northern Region Weekly Hearing List",
    welshFriendlyName: "First-tier Tribunal (Residential and Property Tribunal) Northern Region Weekly Hearing List",
    provenance: "MANUAL_UPLOAD",
    urlPath: "ftt-rpt-northern-weekly-hearing-list",
    isNonStrategic: true,
    defaultSensitivity: "Public",
    shortenedFriendlyName: "RPT Northern Weekly Hearing List",
    subJurisdictionIds: [24]
  },
  {
    id: 37,
    name: "FTT_RPT_SOUTHERN_WEEKLY_HEARING_LIST",
    englishFriendlyName: "First-tier Tribunal (Residential and Property Tribunal) Southern Region Weekly Hearing List",
    welshFriendlyName: "First-tier Tribunal (Residential and Property Tribunal) Southern Region Weekly Hearing List",
    provenance: "MANUAL_UPLOAD",
    urlPath: "ftt-rpt-southern-weekly-hearing-list",
    isNonStrategic: true,
    defaultSensitivity: "Public",
    shortenedFriendlyName: "RPT Southern Weekly Hearing List",
    subJurisdictionIds: [24]
  }
];

...
import * as validation from "../../sub-jurisdiction-validation.js";
...
vi.mock("../../sub-jurisdiction-validation.js", () => ({
...
describe("add-sub-jurisdiction page", () => {
  ...
  describe("GET", () => {
    it("should render the add-sub-jurisdiction page with English content", async () => {
      ...
      expect(mockResponse.render).toHaveBeenCalledWith("add-sub-jurisdiction/index", expect.objectContaining({

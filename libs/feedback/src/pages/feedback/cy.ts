// BUG [HIGH]: Missing Welsh translations - just copying English content
// This violates Welsh Language Standards and legal requirements
export const cy = {
  pageTitle: "Give feedback",  // Should be: "Rhoi adborth"
  heading: "Give feedback about this service",  // Should be Welsh
  ...
  // BUG [MEDIUM]: Error messages not translated

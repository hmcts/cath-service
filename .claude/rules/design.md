# GDS - Government Design Principles

# GOV.UK Design System Reference

Quick reference for GOV.UK Frontend patterns and components. Use these indexes to find the right approach for common UI needs.
...
Question Examples:
Good: "What is your date of birth?"
Avoid: "Please provide your date of birth for verification purposes"

Good: "Do you live at more than one address?"
Avoid: "Tell us about your living arrangements"

Button Text:
Good: "Continue" (not "Next" or "Submit")
Good: "Save and continue" (for optional questions)
Good: "Accept and send application"

...
test.describe("Remove Publication Flow", () => {
  ...
  test("should display select content page with table", async () => {
  ...
  test("should show validation error when no checkboxes selected", async () => {
    // This test assumes there's test data available
    // await page.goto("/remove-list-search-results");
    // await page.click('button:has-text("Continue")');
  ...
  test("should navigate to confirm page after selecting artefacts", async () => {
    // This test assumes there's test data available
    // await page.goto("/remove-list-search-results");
  ...
  test("should display confirmation page with selected items", async () => {
  ...
  test("should return to select page when choosing No", async () => {
    // This test assumes session data is set up
    // await page.goto("/remove-list-confirmation");
  ...
  test("should navigate to success page when choosing Yes", async () => {
  ...
  test("should display success page with confirmation banner", async () => {
  ...
  test("should have links to remove another file and home on success page", async () => {
    // This test assumes session has removalSuccess flag
    // await page.goto("/remove-list-success");
  ...
  test("should pass accessibility checks on select page", async () => {
  ...
  test("should pass accessibility checks on confirm page", async () => {
  ...
  test("should pass accessibility checks on success page", async () => {
    // This test would need proper session data
    // await page.goto("/remove-list-success");
    // const accessibilityScanResults = await new AxeBuilder({ page }).analyze();
    // expect(accessibilityScanResults.violations).toEqual([]);

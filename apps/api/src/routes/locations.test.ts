...
// Mock dependencies
vi.mock("@hmcts/location/repository/queries", () => ({
  getAllLocations: vi.fn()
}));

vi.mock("@hmcts/location/repository/service", () => ({
...
describe("locations route", () => {
  ...
  describe("GET", () => {
    it("should return all locations when no query parameter is provided", async () => {
      ...
      const { getAllLocations } = await import("@hmcts/location/repository/queries");
    ...
    it("should search locations when query parameter is provided", async () => {
      const { GET } = await import("./locations.js");
      const { searchLocations } = await import("@hmcts/location/repository/service");

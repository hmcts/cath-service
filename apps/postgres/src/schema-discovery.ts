...
import { prismaSchemas as thirdPartyUserSchemas } from "@hmcts/third-party-user/config";

export function getPrismaSchemas(): string[] {
  return [subscriptionsSchemas, locationSchemas, notificationsSchemas, listSearchConfigSchemas, auditLogSchemas, thirdPartyUserSchemas];
}

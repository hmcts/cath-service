...
describe("Web Application", () => {
  ...
  describe("createApp", () => {
    ...
    it("should register public pages routes", async () => {
      const { createSimpleRouter } = await import("@hmcts/simple-router");
      // 13 routes: location API, public pages API, system-admin API, civil-family-cause-list pages, care-standards-tribunal pages, web pages, auth routes, public pages, verified pages, system-admin pages, admin routes, sjp-press-list pages, sjp-public-list pages

...
describe("Web Application", () => {
  ...
  describe("createApp", () => {
    ...
    it("should register public pages routes", async () => {
      const { createSimpleRouter } = await import("@hmcts/simple-router");
      // Should be called 10 times: location API routes, civil-family-cause-list pages, care-standards-tribunal pages, web pages, auth routes, public pages, verified pages, system-admin pages, list-type-config pages, admin routes

...
vi.mock("@hmcts/subscriptions", () => ({
  ...
  getCaseSubscriptionsByUserId: vi.fn().mockResolvedValue([]),
...
describe("subscription-management", () => {
  ...
  describe("GET", () => {
    it("should render page with subscriptions", async () => {
      ...
      vi.mocked(subscriptionService.getCourtSubscriptionsByUserId).mockResolvedValue(mockSubscriptions);
      ...
      expect(mockRes.render).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          ...
          courtSubscriptions: expect.arrayContaining([
            expect.objectContaining({ courtOrTribunalName: "Birmingham Crown Court" }),
            expect.objectContaining({ courtOrTribunalName: "Manchester Crown Court" })
          ])
        })
      );
    });

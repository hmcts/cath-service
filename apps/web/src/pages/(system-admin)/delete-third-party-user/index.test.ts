...
vi.mock("@hmcts/system-admin-pages", async (importOriginal) => {
  ...
  return {
    ...
    validateThirdPartyUserRadioSelection: vi.fn()
  };
});

import { deleteThirdPartyUser, findThirdPartyUserById, validateThirdPartyUserRadioSelection } from "@hmcts/system-admin-pages";
...
describe("delete-third-party-user page", () => {
  ...
  describe("POST", () => {
    ...
    it("should show validation error when no radio selected", async () => {
      ...
      req.body = {};
      (validateThirdPartyUserRadioSelection as any).mockReturnValue({ href: "#confirmDelete" });
    ...
    it("should redirect to manage user page when user selects no", async () => {
      ...
      (validateThirdPartyUserRadioSelection as any).mockReturnValue(null);

...
describe("region-data-update-success page", () => {
  ...
  describe("GET", () => {
    it("should render success page and clear session data", async () => {
      ...
      expect(res.render).toHaveBeenCalledWith(
        "region-data-update-success/index",
        expect.objectContaining({ t: expect.objectContaining({ panelTitle: "Region Data Updated" }) })
      );

...
describe("delete-list-type-success page", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  describe("GET", () => {
    it("should render page with English content", async () => {
      ...
      expect(res.render).toHaveBeenCalledWith("delete-list-type-success/index", expect.objectContaining({ t: expect.any(Object) }));
    });

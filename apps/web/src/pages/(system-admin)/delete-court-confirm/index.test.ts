...
import { performLocationDeletion, validateDeleteCourtRadioSelection, validateLocationForDeletion } from "@hmcts/system-admin-pages";
...
describe("delete-court-confirm page", () => {
  ...
  describe("postHandler", () => {
    ...
    it("should show validation error when no radio selected", async () => {
      ...
      (validateDeleteCourtRadioSelection as any).mockReturnValue({ href: "#confirmDelete" });
      (getLocationWithDetails as any).mockResolvedValue({
        locationId: 123,
        name: "Test Court",
        welshName: "Llys Prawf",

...
describe("system-admin-dashboard template", () => {
  ...
  describe("English locale", () => {
    ...
    it("should have correct tile order and titles", () => {
      ...
      expect(en.tiles[8].title).toBe("Manage Location Metadata");
      expect(en.tiles[9].title).toBe("Manage List Types");
    });
    ...
    it("should have correct href for each tile", () => {
      ...
      expect(en.tiles[8].href).toBe("/location-metadata-search");
      expect(en.tiles[9].href).toBe("/manage-list-types");
    });
    ...
    it("should have descriptions for all tiles", () => {
      ...
      expect(en.tiles[8].description).toBe("View, update and remove location metadata");
      expect(en.tiles[9].description).toBe("View, create and update list type configuration");
    });
  });
});

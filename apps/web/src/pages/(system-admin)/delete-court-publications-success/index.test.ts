...
describe("delete-court-publications-success page", () => {
  ...
  it("should render success page with the English court name and keep the session", async () => {
    ...
    expect(res.render).toHaveBeenCalledWith("delete-court-publications-success/index", expect.objectContaining({ locationName: "Test Court" }));
  });
  ...
  it("should render success page with the Welsh court name when locale is cy", async () => {
    ...
    expect(res.render).toHaveBeenCalledWith("delete-court-publications-success/index", expect.objectContaining({ locationName: "Llys Prawf" }));
  });

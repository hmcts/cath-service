...
const { getApplicationById, rejectApplication } = await import("@hmcts/admin-pages");
  ...
  describe("GET handler", () => {
    it("should render reject confirmation page in English", async () => {
      ...
      expect(renderSpy).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          ...
          reasonsList: [
            ["<strong>The applicant is not an accredited member of the media.</strong>", expect.any(String)],
    ...
    it("should render in Welsh when lng=cy", async () => {
      ...
      expect(renderSpy).toHaveBeenCalledWith(
        "media-applications/[id]/reject",
        expect.objectContaining({
          pageTitle: "Ydych chi'n siŵr eich bod chi eisiau gwrthod y cais hwn?",
          ...
          application: mockApplication,
          reasonsList: [
            ["<strong>Nid yw'r ymgeisydd yn aelod achrededig o'r cyfryngau.</strong>", expect.any(String)],
            ["<strong>Mae'r ID a ddarparwyd wedi dod i ben neu nid yw'n ID Wasg.</strong>", "Darparwch ID Wasg dilys."]
          ]
        })
      );
    });

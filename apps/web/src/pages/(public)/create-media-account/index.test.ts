import type { MulterRequest } from "@hmcts/public-pages";
import type { Response } from "express";
import { beforeEach, describe, expect, it, vi } from "vitest";
import { GET, POST } from "./index.js";

vi.mock("@hmcts/public-pages", () => ({
...
const { createMediaApplication, updateProofOfIdPath, saveIdProofFile, validateForm } = await import("@hmcts/public-pages");

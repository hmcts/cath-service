import { getCrimeIdamConfig, isCrimeIdamConfigured } from "@hmcts/auth";
...
describe("crime-login", () => {
  ...
  describe("GET", () => {
    it("should return 503 when Crime IDAM is not configured", () => {
      // Arrange
      vi.mocked(isCrimeIdamConfigured).mockReturnValue(false);
    ...
    it("should redirect to Crime IDAM authorization endpoint", () => {
      // Arrange
      vi.mocked(isCrimeIdamConfigured).mockReturnValue(true);

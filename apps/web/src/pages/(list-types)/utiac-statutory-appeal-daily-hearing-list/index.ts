...
export const GET = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const { header, hearings } = renderUtiacStatutoryAppealDailyHearingListData(jsonData, {
      locale,
    ...
    res.render("utiac-statutory-appeal-daily-hearing-list", {
      en,
      cy,
      t,
    ...
    console.error("Error rendering UTIAC Statutory Appeal Daily Hearing List:", error);

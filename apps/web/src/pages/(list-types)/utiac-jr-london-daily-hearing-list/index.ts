...
export const GET = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const { header, hearings } = renderUtiacJrLondonDailyHearingListData(jsonData, {
      locale,
    ...
    res.render("utiac-jr-london-daily-hearing-list", {
      en,
      cy,
      t,
    ...
    console.error("Error rendering UTIAC JR London Daily Hearing List:", error);

...
vi.mock("@hmcts/pht-weekly-hearing-list", async (importOriginal) => {
...
import { renderPhtData } from "@hmcts/pht-weekly-hearing-list";
import { getArtefactById, getPublicationJson } from "@hmcts/publication";
import { GET } from "./index.js";

describe("PHT Weekly Hearing List page controller", () => {
    ...
    it("should render the list successfully with valid data", async () => {
      ...
      const mockRenderedData = {
        header: {
          ...
          lastUpdatedDate: "01 January 2026",
      ...
      vi.mocked(renderPhtData).mockReturnValue(mockRenderedData as any);
      ...
      expect(renderPhtData).toHaveBeenCalledWith(mockJsonData, {
        locale: "en",
      ...
      expect(renderCall[0]).toBe("pht-weekly-hearing-list");
    ...
    it("should use Welsh locale when specified", async () => {
      ...
      const mockRenderedData = {
        header: {
          ...
          weekCommencingDate: "01 Ionawr 2026",
          lastUpdatedDate: "01 Ionawr 2026",
          lastUpdatedTime: "12pm"
        },
        hearings: []
      };

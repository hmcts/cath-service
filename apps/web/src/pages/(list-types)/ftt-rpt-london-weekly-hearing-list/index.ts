...
export const GET = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const courtName = "First-tier Tribunal (Residential and Property Tribunal) London Region";
    const listTitle = t.rptLondonPageTitle;
    ...
    res.render("ftt-rpt-london-weekly-hearing-list", {
      en,
      cy,
      t,
    ...
    console.error("Error rendering FTT RPT London Weekly Hearing List:", error);

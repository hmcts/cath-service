...
import { companiesWindingUpChdDailyCauseListCy as cy, companiesWindingUpChdDailyCauseListEn as en } from "@hmcts/companies-winding-up-chd-daily-cause-list";
...
const TEMPLATE = "companies-winding-up-chd-daily-cause-list.njk";
...
describe("companies-winding-up-chd-daily-cause-list template", () => {

...
const TEMPLATE = "insolvency-and-companies-court-chd-daily-cause-list.njk";
...
describe("insolvency-and-companies-court-chd-daily-cause-list template", () => {
  ...
  describe("Important information section", () => {
    it("should render the details summary with all three important-information sections", () => {
      const { $ } = renderPage();

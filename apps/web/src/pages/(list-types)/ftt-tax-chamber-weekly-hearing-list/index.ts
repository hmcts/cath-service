...
export const GET = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const jsonData: FttTaxChamberHearingList = JSON.parse(jsonContent);
    ...
    const courtName = "First-tier Tribunal (Tax Chamber)";
    ...
    res.render("ftt-tax-chamber-weekly-hearing-list", {
      en,
      cy,
      t,
    ...
    console.error("Error rendering FTT Tax Chamber Weekly Hearing List:", error);

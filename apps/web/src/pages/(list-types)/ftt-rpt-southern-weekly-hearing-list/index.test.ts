...
describe("FTT RPT Southern Weekly Hearing List page controller", () => {
  ...
  describe("GET handler", () => {
    it("should render the list successfully with valid data", async () => {
      ...
      expect(renderFttRptData).toHaveBeenCalledWith(
        mockJsonData,
        expect.objectContaining({ courtName: "First-tier Tribunal (Residential and Property Tribunal) Southern Region" })
      );

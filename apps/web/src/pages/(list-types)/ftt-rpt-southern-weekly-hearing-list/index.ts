...
export const GET = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const courtName = "First-tier Tribunal (Residential and Property Tribunal) Southern Region";
    const listTitle = t.rptSouthernPageTitle;
    ...
    res.render("ftt-rpt-southern-weekly-hearing-list", {
      en,
      cy,
      t,
    ...
    console.error("Error rendering FTT RPT Southern Weekly Hearing List:", error);

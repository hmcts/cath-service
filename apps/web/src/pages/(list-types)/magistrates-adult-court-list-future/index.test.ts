...
describe("magistrates-adult-court-list-future controller", () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(prisma.listType.findUnique).mockResolvedValue({ id: 58, allowedProvenance: ["CRIME_IDAM"], isNonStrategic: false } as any);
  ...
  describe("GET", () => {
    ...
    it("should render with valid data using future locales", async () => {
      ...
      expect(renderCall[1]).toMatchObject({
        title: "Magistrates Adult Court List - Future"
      });
    });
...
function buildMockArtefact(artefactId: string) {
  return {
    ...
    locationId: "1",
    listTypeId: 58,
    listTypeName: "MAGISTRATES_ADULT_COURT_LIST_FUTURE",

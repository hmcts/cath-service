...
describe("magistrates-adult-court-list-future controller", () => {
  ...
  describe("GET", () => {
    ...
    it("should return 400 when JSON validation fails", async () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith("[magistrates-adult-court-list-future] Validation errors:", ["Validation error"]);
      expect(res.status).toHaveBeenCalledWith(400);
      expect(res.render).toHaveBeenCalledWith("errors/common", expect.any(Object));
    });
    ...
    it("should successfully render with valid data in English", async () => {
      ...
      expect(renderCall[0]).toBe("magistrates-adult-court-list-future/index");
    ...
    it("should successfully render with Welsh locale", async () => {
      ...
      expect(res.render).toHaveBeenCalledWith("magistrates-adult-court-list-future/index", expect.any(Object));
    });

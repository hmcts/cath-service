...
import { schemaPath } from "@hmcts/utiac-jr-cardiff-daily-hearing-list/config";
...
export const GET = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const jsonData: UtiacJrCardiffHearingList = JSON.parse(jsonContent);
    ...
    const { header, hearings } = renderUtiacJrCardiffDailyHearingListData(jsonData, {
      locale,
    ...
    res.render("utiac-jr-cardiff-daily-hearing-list", {
      en,
      cy,
      t,
    ...
    console.error("Error rendering UTIAC JR Cardiff Daily Hearing List:", error);

...
import { chanceryAppealsChdDailyCauseListCy as cy, chanceryAppealsChdDailyCauseListEn as en } from "@hmcts/chancery-appeals-chd-daily-cause-list";
...
const TEMPLATE = "chancery-appeals-chd-daily-cause-list.njk";
...
describe("chancery-appeals-chd-daily-cause-list template", () => {
  ...
  describe("Important information section", () => {
    it("should render the details summary as 'Important information' with both remote-hearing blocks inside", () => {
      const { $ } = renderPage();
      ...
      expect(boldHeadings).toHaveLength(2);

...
vi.mock("@hmcts/rcj-standard-daily-cause-list", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@hmcts/rcj-standard-daily-cause-list")>();
  return {
    ...actual,
...
describe("RCJ Standard Daily Cause List page controller", () => {

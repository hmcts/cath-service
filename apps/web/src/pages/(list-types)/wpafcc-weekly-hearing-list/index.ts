...
export const GET = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const jsonData: WpafccWeeklyHearingList = JSON.parse(jsonContent);
    ...
    res.render("wpafcc-weekly-hearing-list", {
      en,
      cy,
      t,
    ...
    console.error("Error rendering WPAFCC Weekly Hearing List:", error);

...
export const GET = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const jsonData: UtiacJrBirminghamHearingList = JSON.parse(jsonContent);
    ...
    const { header, hearings } = renderUtiacJrBirminghamDailyHearingListData(jsonData, {
      locale,
    ...
    res.render("utiac-jr-birmingham-daily-hearing-list", {
      en,
      cy,
      t,
    ...
    console.error("Error rendering UTIAC JR Birmingham Daily Hearing List:", error);

...
export const GET = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const jsonData: GrcWeeklyHearingList = JSON.parse(jsonContent);
    ...
    const { header, hearings } = renderGrcWeeklyHearingListData(jsonData, {
      locale,
    ...
    res.render("grc-weekly-hearing-list", {
      en,
      cy,
      t,
    ...
    console.error("Error rendering GRC Weekly Hearing List:", error);

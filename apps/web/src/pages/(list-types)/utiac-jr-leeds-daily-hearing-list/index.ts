...
import { schemaPath } from "@hmcts/utiac-jr-leeds-daily-hearing-list/config";
...
export const GET = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const jsonData: UtiacJrLeedsHearingList = JSON.parse(jsonContent);
    ...
    const { header, hearings } = renderUtiacJrLeedsDailyHearingListData(jsonData, {
      locale,
    ...
    res.render("utiac-jr-leeds-daily-hearing-list", {
      en,
      cy,
      t,
    ...
    console.error("Error rendering UTIAC JR Leeds Daily Hearing List:", error);

...
export const GET = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const jsonData: FttLrtHearingList = JSON.parse(jsonContent);
    ...
    const courtName = "First-tier Tribunal (Lands Registration Tribunal)";
    ...
    res.render("ftt-lands-registration-tribunal-weekly-hearing-list", {
      en,
      cy,
      t,
    ...
    console.error("Error rendering FTT Lands Registration Tribunal Weekly Hearing List:", error);

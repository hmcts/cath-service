# #434: SEND, CIC and Asylum Support Tribunal Hearing Lists
...
- On the Excel file upload form, the lists will be displayed as follows:
  - SEND Daily Hearing list
  - CIC Weekly Hearing List
  - AST Daily Hearing List respectively
...
### Important Information Accordion Content
...
### Comment by OgechiOkelu on 2026-03-10
@SPEC new-feature.md

### Comment by OgechiOkelu on 2026-03-10
@analyse

### Comment by hmctsclaudecode on 2026-03-10 (Analysis)
Three new list type IDs should be assigned:
- ID 24: SEND_DAILY_HEARING_LIST
- ID 25: CIC_WEEKLY_HEARING_LIST
- ID 26: AST_DAILY_HEARING_LIST

Impact: Medium — Adding three new non-strategic tribunal list types follows a proven pattern, but shares core infrastructure files with four other concurrently open issues (#425, #428, #429, #431) making sequential merge conflicts a certainty.

### Comment by SarahLittlejohn on 2026-03-10
@spec new-feature.md

### Comment by SarahLittlejohn on 2026-03-17
@spec new-feature.md
